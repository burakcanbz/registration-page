...
import { Stack, Checkbox, Button, Link, Typography, TextField, FormControlLabel } from '@mui/material'
...
import { MyPaper, MyAvatar } from '../../styledComponents/common';
import './login.css';
import { RootState } from '../../store/store'; // Adjust the import according to your store file location
